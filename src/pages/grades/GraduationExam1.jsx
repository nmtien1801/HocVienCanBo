...
export default function GraduationExam1() {
  ...
  const fetchListExamination = async () => {
    ...
    setError(null);
    try {
      let res = await dispatch(getListGraduateExamination({ classID: selectedClass, subjectID: selectedSubject, page: currentPage, limit: pageSize }));
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-[1600px] mx-auto">
        {/* Header */}
        <h1 className="text-xl md:text-2xl text-gray-600 mb-6">Danh sách dự thi tốt nghiệp 1</h1>
