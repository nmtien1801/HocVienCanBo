...
import { getListExaminationsL2 } from '../../redux/pointSlice.js';
...
export default function FinalExam2() {
  ...
  const fetchListExamination = async (customPage = currentPage, customLimit = pageSize) => {
    ...
    setError(null);
    try {
      let res = await dispatch(getListExaminationsL2({ subjectID: selectedSubject, page: customPage, limit: customLimit }));
  ...
  const handleExportExcel = async () => {
    if (!ExaminationTotal2 || ExaminationTotal2 === 0) {
    ...
    try {
      ...
      const fullData = await fetchListExamination(1, ExaminationTotal2);
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, "danh sách dự thi cuối môn lần 2");
      XLSX.writeFile(workbook, `Danh_sach_du_thi_cuoi_mon_lan_2_${new Date().getTime()}.xlsx`);
  ...
  const totalPages = Math.ceil(ExaminationTotal2 / pageSize);
  ...
  const renderTableBody = () => {
    ...
    // Empty State)
    if (!ExaminationList2 || ExaminationList2.length === 0) {
      return (
        <tr>
          <td colSpan="12" className="px-4 py-12 text-center">
            <div className="flex flex-col items-center justify-center gap-3">
    ...
    // Data Rows
    return ExaminationList2.map((row, index) => (
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-[1600px] mx-auto">
        {/* Header */}
        <h1 className="text-xl md:text-2xl text-gray-600 mb-6">Danh sách dự thi cuối môn lần 2</h1>
          ...
          <div className="flex flex-col md:flex-row flex-wrap items-stretch md:items-center gap-4 md:gap-6">
            ...
            <div className='flex gap-4'>
              ...
              <button
                ...
                disabled={isLoading || !ExaminationList2 || ExaminationList2.length === 0}
              >
                <FileDown size={16} />
        ...
        <div className="bg-white rounded-lg shadow-sm">
          ...
          {/* Pagination */}
          {!isLoading && !error && ExaminationList2 && ExaminationList2.length > 0 && (
            ...
            <div className="p-4 md:px-6 md:py-4 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-end gap-4">
                <span className="text-sm text-gray-600 whitespace-nowrap">
                  Hiển thị {((currentPage - 1) * pageSize) + 1} - {Math.min(currentPage * pageSize, ExaminationTotal2)} / {ExaminationTotal2} kết quả
                </span>
                <div className="flex items-center gap-2">
