...
export default function Lookup() {
  ...
  const fetchScheduleSubjectMonth = async () => {
    let res = await dispatch(getScheduleSubjectMonth({ startDate, endDate, subjectID: selectedSubject, page: currentPage, limit: pageSize }));
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex items-center gap-6">
            ...
            <button className="bg-teal-500 hover:bg-teal-600 text-white px-6 py-2 rounded flex items-center gap-2 text-sm" onClick={() => fetchScheduleSubjectMonth()} >
              <Search size={16} />
              Tìm kiếm
            </button>
        ...
        <div className="bg-white rounded-lg shadow-sm">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {scheduleSubjectMonth.map((row, index) => (
