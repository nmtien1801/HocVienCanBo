...
import { getScheduleGraduationMonth } from '../../redux/scheduleSlice.js';
...
export default function ScheduleExamMonth() {
  ...
  const { GraduationMonthList, GraduationMonthTotal } = useSelector((state) => state.schedule);
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-[1600px] mx-auto">
        {/* Header */}
        <h1 className="text-xl md:text-2xl text-gray-600 mb-6">Lịch Thi trong Tháng</h1>
          ...
          <div className="flex flex-col md:flex-row flex-wrap items-stretch md:items-center gap-4 md:gap-6">
            ...
            <div className='flex gap-4 w-full md:w-auto'>
              ...
              <button
                ...
                disabled={isLoading || !GraduationMonthList || GraduationMonthList.length === 0}
              >
                <FileDown size={16} />
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                ...
                {/* Empty State */}
                {!isLoading && !error && (!GraduationMonthList || GraduationMonthList.length === 0) && (
                  <tr>
                    <td colSpan="12" className="px-4 py-12 text-center">
                      <div className="flex flex-col items-center justify-center gap-3">
                ...
                {/* Data Rows */}
                {!isLoading && !error && GraduationMonthList && GraduationMonthList.length > 0 && GraduationMonthList.map((row, index) => (
                  <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 border-r border-gray-200 text-center">{row.TimeExam}</td>
                    <td className="px-4 py-3 border-r border-gray-200 text-center">{row.TeacherName}</td>
                    <td className="px-4 py-3 text-center">{row.DescriptionExam}</td>
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            <div className="p-4 md:px-6 md:py-4 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-end gap-4">
                <span className="text-sm text-gray-600 whitespace-nowrap">
                  Hiển thị {((currentPage - 1) * pageSize) + 1} - {Math.min(currentPage * pageSize, GraduationMonthTotal)} / {GraduationMonthTotal} kết quả
                </span>
                <div className="flex items-center gap-2">
