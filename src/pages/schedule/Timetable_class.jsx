...
export default function TimetableClass() {
  ...
  const renderTableBody = () => {
    ...
    // Data Rows
    return scheduleClass.map((row, index) => (
      <tr key={index} className="border-b border-gray-200 hover:bg-gray-50">
        ...
        <td className="px-4 py-3 border-r border-gray-200 text-center whitespace-nowrap">{row.WeekDay}</td>
        <td className="px-4 py-3 border-r border-gray-200 text-center whitespace-nowrap">{row.NumberOfSessionReal}</td>
        <td className="px-4 py-3 border-r border-gray-200 text-center whitespace-nowrap">{formatDate(row.DateStart)}</td>
        <td className="px-4 py-3 text-center whitespace-nowrap">{formatDate(row.DateEnd)}</td>
        <td className="px-4 py-3 border-r border-gray-200 text-center whitespace-nowrap">{formatDate(row.DateNumberDayGraduation)}</td>
      </tr>
    ));
  };
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-[1600px] mx-auto">
        {/* Header */}
        <h1 className="text-xl md:text-2xl text-gray-600 mb-6">Thời khóa biểu của lớp</h1>
          ...
          <div className="flex flex-col md:flex-row flex-wrap items-stretch md:items-center gap-4 md:gap-6">
            ...
            <div className='flex gap-4'>
              ...
              <button
                ...
                disabled={isLoading || !scheduleClass || scheduleClass.length === 0}
              >
                <FileDown size={16} />
        ...
        <div className="bg-white rounded-lg shadow-sm">
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-100 border-b-2 border-gray-300">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left text-gray-700 font-semibold border-r border-gray-300 whitespace-nowrap">Mã môn</th>
                  ...
                  <th className="px-4 py-3 text-left text-gray-700 font-semibold border-r border-gray-300 whitespace-nowrap">Số buổi học</th>
          ...
          {/* Pagination */}
          {!isLoading && !error && scheduleClass && scheduleClass.length > 0 && (
            ...
            <div className="p-4 md:px-6 md:py-4 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-end gap-4">
                <span className="text-sm text-gray-600 whitespace-nowrap">
                  Hiển thị {((currentPage - 1) * pageSize) + 1} - {Math.min(currentPage * pageSize, totalScheduleClass)} / {totalScheduleClass} kết quả
                </span>
                <div className="flex items-center gap-2">
