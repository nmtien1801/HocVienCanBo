...
function MyPage() {
    const STYLE_CLASSES = {
        ...
        DATA_SECONDARY: "px-4 py-2 text-sm text-gray-600 border", 
        DATA_PRIMARY_CENTERED: "px-4 py-2 text-sm text-gray-900 border text-center",
        DATA_PRIMARY: "px-4 py-2 text-sm text-gray-900 border", 
    };
