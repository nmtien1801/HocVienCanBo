...
const ManagerSurvey = () => {
    ...
    const [templateForm, setTemplateForm] = useState({ TemplateSurveyID: '', TypeTemplate: 1, Title: '', ShorDescription: '', Requiments: '', StatusID: true, ImagePath: '', Permission: 0, ClassTypeID: 1, });
            ...
            <div key={question.id} className="ml-12 mb-2">
                <div className="flex items-start gap-3 p-3 bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition group">
                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition">
                        <button onClick={() => deleteItem('question', question.templateSurveyCriteriaID, { catId, grpId })} className="p-1 text-red-600 hover:bg-red-50 rounded" title="Xóa câu hỏi"><Trash2 className="w-4 h-4" /></button>
                    </div>
                </div>
            </div>
        );
            ...
            <div className="max-w-0xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-4">
                        <h1 className="text-2xl md:text-3xl font-xl text-gray-700">Mẫu phiếu khảo sát giảng viên</h1>
                    </div>
                    <button
