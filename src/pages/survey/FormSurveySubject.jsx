...
// Import thêm icon cho Control Board và CRUD
...
      await ApiTemplateSurveys.CreateSurveySubjectApi(payload);
...
      await ApiTemplateSurveys.DeleteSurveySubjectApi(payload);
...
            Quản lý Đánh giá và Môn học: **{evaluationName || 'Thêm mới'}**
          </h3>
