...
const ApiReport = {
    ...
    getListSurveyOtherApi: (page, limit) => ApiManager.get(`/survey/get-list-survey-other?page=${page}&limit=${limit}`),
    ...
    getReportTrackingOrderDBApi: (templateSurveyID, classID, page, limit) => ApiManager.get(`/report-tracking/report-tracking-other-BD?templateSurveyID=${templateSurveyID}&classID=${classID}&page=${page}&limit=${limit}`),
}
